...
# Vercel's deployed filesystem is read-only. Use /tmp for runtime uploads.
# Local development keeps uploads inside backend/uploads.
UPLOADS_DIR = os.environ.get(
    "SCAMX_UPLOADS_DIR",
    "/tmp/scamx_uploads" if os.environ.get("VERCEL") else os.path.join(os.path.dirname(__file__), "uploads")
)
